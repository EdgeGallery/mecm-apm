...
package org.edgegallery.mecm.apm.apihandler.access;
...
public class AccessTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (request.getRequestURI() == null || !request.getRequestURI().equals(HEALTH_URI)) {
            ...
            if (userIdFromRequest != null && !StringUtils.isEmpty(userIdFromRequest)
                    && !userIdFromRequest.equals(userIdFromToken)) {
