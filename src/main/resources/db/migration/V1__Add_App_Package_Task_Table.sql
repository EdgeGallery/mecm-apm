    ...
    create table if not exists apppackagehost (
    ...
    create table if not exists apmtenant (
        tenant  varchar(255) not null,
        primary key (tenant)
    );

    create table if not exists apppackageinfo (
        id varchar(255) not null,
        app_id  varchar(255) not null,
    ...
    create table if not exists apptemplateinputattr (
